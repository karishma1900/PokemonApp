  ...
  const getStats = () =>{
    ...
    return (
        ...
        <div className="pokemon-types">
            <div className="pokemon-type-title">Strength</div>
        ...
        <div className="pokemon-types">
            <div className="pokemon-type-title">Resistance</div>
            <div className="pokemon-type-icons">
                {
        ...
        <div className="pokemon-types">
            <div className="pokemon-type-title">Vulnerable</div>
            <div className="pokemon-type-icons">
                {
        ...
        <div className="pokemon-types">
            <div className="pokemon-type-title">Weakness</div>
            <div className="pokemon-type-icons">
                {
    ...
    }
    {
        ...
        <div className="compare-element">
          ...
          <div className="compare-action-buttons">
            ...
            onClick={()=>dispatch(removeFromCompare({id:pokemon?.id}))}>Remove</button>
          </div>
        </div>
    }
  </div>
